...
displacement_x = 0
step_size_vert = 30 # Speed differenciation of Green and red squares / Seems to not really influence the causality 
step_size_rouge = 10

while abs(square_red.position[0] - square_vert.position[0]) > 65: 
